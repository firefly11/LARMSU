...
def regionGrowing(im_array, aspect, slope, aspectZonal, shppath, xyPath, demFilename,
                        ...
                        if isC_flag == -1:
                            ...
                            if aspectZonal[ii, jj] == aspectZonal[ii + x, jj + y]:
                                ...
                                if 90 <= abs(aspectZonal[ii, jj] - aspectZonal[ii + x, jj + y]) <= 180:
                                    ...
                                    isC_flag = aspect[ii, jj] if 90 <= abs(
                                        aspect[ii, jj] - aspectZonal[ii + x, jj + y]) <= 180 else aspectZonal[
                                        ii, jj]
...
def SUsM(pro_name, sourceShpPath, DEMPath, dx, u, maxV, diff_angle, times, outFilePath,
         gridNew, aspect, slope, aspectZonal_ali):
    ...
    result, f, s = regionGrowing(gridNew, aspect, slope, aspectZonal_ali, sourceShpPath, xyPath, DEMPath,
                                 dx, u, maxV, diff_angle, times)
